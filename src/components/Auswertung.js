...
const Auswertung = ({ navigateToAngebotseite }) => { // navigateToAngebotseite als Prop erhalten
  ...
  const [unternehmensangebote, setUnternehmensangebote] = useState([
    ...
    { 
      ...
      description: "Mit unseren Büroanwendungen können Unternehmen effizient arbeiten, Dokumente erstellen, Tabellenkalkulationen durchführen und Präsentationen erstellen. Unsere maßgeschneiderten Lösungen bieten flexible und benutzerfreundliche Tools wie Microsoft Office, Google Workspace und weitere, um die Produktivität und Zusammenarbeit im Büro zu maximieren.", 
      image: OfficeToolsIcon
    },
    { 
      id: 3, 
      title: "Immer und überall verbunden", 
      description: "Unsere Kommunikationslösungen erleichtern die Zusammenarbeit und den Austausch von Informationen zwischen Teammitgliedern. Mit Messaging-Apps, Videokonferenzplattformen und E-Mail-Clients ermöglichen wir nahtlose Kommunikation und Zusammenarbeit, unabhängig von Standorten und Geräten.", 
        ...
        {einzelmetriken.map((metrik, index) => (
          <React.Fragment key={index}>
            ...
            <Col md={7} className="mt-4 mt-md-0">
              <Unternehmensangebot key={unternehmensangebote[index].id} angebot={unternehmensangebote[index]} />
            </Col>
          </React.Fragment>
        ))}
      </Row>
